...
vector<vector<float> > getXYData (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string filex("./data/data_SUB_train_test_20201216/posX/posX");
    std::string filey("./data/data_SUB_train_test_20201216/posY/posY");
...
void getRealTestFRs (int numNeurons, int numNeuronsAll, int numPaths, float** out_arr) {

    // std::string fileNeuronFR("./data/data_SUB_train_test_20201216/meanLR/meanLR_Path_");
    string dataDir = "./data/data_SUB_train_test_20201216/";
...
vector<float> getAngVel (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileAngVel("./data/data_SUB_train_test_20201216/angVel/angVel");
...
vector<float> getLinVel (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileLinVel("./data/data_SUB_train_test_20201216/linVel/linVel");
    std::string stim("Stim_");
...
vector<float> getHeadDir (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileHeadDir("./data/data_SUB_train_test_20201216/headDir/headDir");
    std::string stim("Stim_");
...
vector<float> getOcc (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileOcc("./data/data_SUB_train_test_20201216/occ/occ");
    std::string stim("Stim_");
...
//     std::ifstream xpref;
//     xpref.open("./data/data_SUB_train_test_20201216/PreferredXCoords.csv");
//     std::ifstream ypref;
//     ypref.open("./data/data_SUB_train_test_20201216/PreferredYCoords.csv");
...
//     progpref.open("./data/data_SUB_train_test_20201216/PreferredProg.csv");
...
//     linvelpref.open("./data/data_SUB_train_test_20201216/PreferredLV.csv");
...
//     angvelpref.open("./data/data_SUB_train_test_20201216/PreferredAV.csv");
