...
vector<vector<float> > getXYData (int rec, int posTrajType, bool testing, int trial, int bins) {
    vector<vector<float> > out_arr(2, vector<float>(bins, 0.0));
    ...
    std::string filex("./data/data_HPC_train_test_20201204/posX/posX");
    std::string filey("./data/data_HPC_train_test_20201204/posY/posY");
...
void getRealTestFRs (int numNeurons, int numPaths, float** out_arr) {

    // std::string fileNeuronFR("./data/data_HPC_train_test_20201204/meanLR/meanLR_Path_");
    string dataDir = "./data/data_HPC_train_test_20201204/";
    ...
    for (int path = 0; path < numPaths; path ++) {
        ...
        data = loadData(dataFile, 322, numBins); 
...
vector<float> getAngVel (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileAngVel("./data/data_HPC_train_test_20201204/angVel/angVel");
...
vector<float> getLinVel (int rec, int posTrajType, bool testing, int trial, int bins) {
    vector<float> out_arr(bins, 0.0f);
    ...
    std::string fileLinVel("./data/data_HPC_train_test_20201204/linVel/linVel");
    std::string stim("Stim_");
...
vector<float> getHeadDir (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileHeadDir("./data/data_HPC_train_test_20201204/headDir/headDir");
    std::string stim("Stim_");
...
vector<float> getOcc (int rec, int posTrajType, bool testing, int trial, int bins) {
    ...
    std::string fileOcc("./data/data_HPC_train_test_20201204/occ/occ");
    std::string stim("Stim_");
...
void getCoordPrefs (float * out_arr_x, float * out_arr_y, int size) {
    ...
    std::ifstream xpref;
    xpref.open("./data/data_HPC_train_test_20201204/PreferredXCoords.csv");
    std::ifstream ypref;
    ypref.open("./data/data_HPC_train_test_20201204/PreferredYCoords.csv");
...
void getProgPrefs (float * out_arr, int size) {
    ...
    progpref.open("./data/data_HPC_train_test_20201204/PreferredProg.csv");
...
void getLVPrefs (float * out_arr, int size) {
    ...
    linvelpref.open("./data/data_HPC_train_test_20201204/PreferredLV.csv");
...
void getAVPrefs (float * out_arr, int size) {
    ...
    angvelpref.open("./data/data_HPC_train_test_20201204/PreferredAV.csv");
...
vector<vector<float> > loadData(string file, int numRow, int numCol) {
    vector<vector<float> > out_data(numRow, vector<float>(numCol, 0.0));
